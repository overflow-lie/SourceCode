...
public class HttpHandle implements Runnable {
	...
	private Object msg;
	private String buf;
	private static final Logger logger = Logger.getLogger(HttpHandle.class.getName());

	public HttpHandle(ChannelHandlerContext ctx, Object msg) {
		this.ctx = ctx;
		this.msg = msg;
	}

	public HttpHandle(ChannelHandlerContext ctx, Object msg, String buf) {
		this.ctx = ctx;
		this.msg = msg;
		this.buf = buf;
	}
