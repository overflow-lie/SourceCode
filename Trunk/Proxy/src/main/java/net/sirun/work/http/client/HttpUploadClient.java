...
public class HttpUploadClient {
    ...
    private static List<Entry<String, String>> formGet(Bootstrap bootstrap, String host, int port, String get,
        ...
        encoder.addParam("secondinfo", "secondvalue 中文");
        ...
        headers.set(HttpHeaders.Names.ACCEPT_LANGUAGE, "zh-CN,zh;q=0.8,en-US;q=0.6,en;q=0.4");
        //不加前置连接
        //headers.set(HttpHeaders.Names.REFERER, uriSimple.toString());
        // 伪装chrome 30版本 浏览器
        headers.set(HttpHeaders.Names.USER_AGENT, "Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1588.0 Safari/537.36");
        ...
        entries.get(0).setValue("127.0.0.1");
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 2) {
            ...
            baseUri = "http://172.32.5.217:6060";
    ...
    private static final String textAreaLong =
            "lkjlkjlKJLKJLKJLKJLJlkj lklkj\r\n\r\nLKJJJJJJJJKKKKKKKKKKKKKKK desktop&\r\n\r\n"
