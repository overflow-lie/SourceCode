 ...
 */
public class NewPOSTHandler extends
		SimpleChannelInboundHandler<HttpObject> {

	private static final Logger logger = Logger
			.getLogger(NewPOSTHandler.class.getName());
	...
	public void channelRead0(ChannelHandlerContext ctx, HttpObject msg)
			throws Exception {
//		System.out.println(".<-");
		System.out.println(".<-"+NettyChannelMap.getProperty(ctx.channel().toString()));
		NettyChannelMap.addProperty(ctx.channel().toString(), msg);
